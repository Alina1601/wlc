document.addEventListener("DOMContentLoaded", async function () {
  ...
  const languageSwitcher = document.querySelector(".language-switcher"); // Элемент, к которому добавим класс show

  // Добавляем обработчик клика для кнопки "UA"
  if (uaBtn && plBtn && enBtn && languageSwitcher) {
    uaBtn.addEventListener("click", function () {
      ...
      languageSwitcher.classList.toggle("show"); // Добавляем или удаляем класс "show" у .language-switcher
    });
  }
